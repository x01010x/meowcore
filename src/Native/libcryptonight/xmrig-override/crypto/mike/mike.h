...
#ifndef XMRIG_MIKE_HASH_H
#define XMRIG_MIKE_HASH_H
...
void hash(const uint8_t* data, size_t size, uint8_t* output, cryptonight_ctx** ctx, HelperThread* helper, bool verbose = true);
